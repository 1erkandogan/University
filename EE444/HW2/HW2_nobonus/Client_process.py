...
while True:
    operation = input("Enter operation (GET, PUT, CLR, ADD): ").upper()

    if operation == "GET" or operation == "PUT" or operation == "ADD":
        ...
        print("Invalid operation. Please enter GET, PUT, CLR, or ADD.")
        continue
